...
This policy describes the mobile game **Xal's Path** (the "App") published by **Kevin Logan**. We do **not** operate our own user accounts, login system, or game servers for the App. We collect very little information ourselves; most data stays on your device or is handled by platform and service providers as described below.

**Contact:** 70ipcl2n9@mozmail.com

This policy is written for **U.S. distribution**. We are **not** marketing or targeting the App in the European Economic Area (EEA), UK, or Switzerland. If you use the App from those regions, platform providers’ terms may still apply.
...
|----------|-------------------|
| Name, email, or account you create *with us* | **No** — we do not offer in-app registration with the developer. |
...
The App saves game state to a **local file** on your device (for example under the app’s private storage). That file is **not uploaded to our servers** by the App code we ship. Uninstalling the App or clearing app data may delete it. **Back up** using platform backup features if you want to keep it.
...
If you sign in to **Game Center** (iOS) or **Google Play Games** (Android), **Apple** or **Google** processes account and gameplay-related data under their policies. We use that integration (via **CloudOnce**) primarily to **report and display achievements**. We do not receive your full Apple ID or Google account details in a way that lets us run a separate “Xal’s Path account” on our own systems.
...
The App is **not directed to children under 13**. We do not knowingly collect personal information from children under 13. If you believe we have received such information, contact us at the email above and we will take appropriate steps.
...
We may update this policy when the App or our practices change. The “Last updated” date at the top will change when we do. Continued use of the App after an update means you accept the revised policy.

---

## Disclaimer

This document is provided for transparency about how the App is built **today**. It is **not** legal advice. Have a qualified attorney review it before you publish, especially if you change stores, regions, SDKs, or data practices.
